 ...
 * =====================================================================================
 *    @file:    Hashtable.h
 *    @brief:   哈希表类,对哈希表的一些基本操作的封装
 *    @author:  
 *    @version: 1.0
 *    @date:    修订说明：
 *              1.0-2012.11.25-shiping.liang-创建
 * =====================================================================================
 */
...
private:
    ...
    unsigned int next_prime(const unsigned int &nStart);
...
void CHashtable<Key,Value>::rehash()
{
	...
	unsigned int newTableSize = next_prime(2 * oldTableSize);
...
template <class Key, class Value>
unsigned int CHashtable<Key, Value>::next_prime(const unsigned int &nStart)
{
    enum { NUM_PRIMES = 28 };
